...
if (!jobId) {
  console.error("Usage: npm run coach:new-runtime-verification -- --job-id <job-id> [--shot-id <shot-id>] [--tester <name>]");
  process.exit(1);
}

const root = resolve(dirname(fileURLToPath(import.meta.url)), "..");
const templatePath = join(root, "docs", "coach-runtime-verification-template.md");
const outputDir = join(root, "docs", "runtime-verifications");
