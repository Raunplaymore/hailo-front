...
export function Shell<T extends string>({
  ...
  return (
    <div className="min-h-[100dvh] w-full overflow-x-hidden bg-background px-3 pb-[calc(env(safe-area-inset-bottom,0px)+11rem)] pt-4 text-foreground sm:px-6 sm:pt-5 lg:min-h-screen lg:pb-10 lg:pt-8">
